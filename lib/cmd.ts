...
const theme = `<span class="text-neon-red dark:text-neon-yellow">Theme changed</span>`;
const contact = `<span class="text-neon-red dark:text-neon-yellow">marceljoshua69@gmail.com</span> has been copied to your clipboard.`;
const projects = `All projects are <span class="text-neon-red">private</span>. Please contact me for more information.`;
const social = `twitter       <a target="_blank" href="https://twitter.com/buruhkodingg"><span class="text-neon-red dark:text-neon-yellow">https://twitter.com/buruhkodingg</span></a>
...
const footer = `<div class="flex w-full items-center justify-between"><p class="dark:text-neon-purple text-neon-purple">marceljsh</p><p class="dark:text-neon-yellow text-neon-red" style="margin-left: auto;">2024 All rights reserved</p></div>`;
const hello = `Hello :D`;
